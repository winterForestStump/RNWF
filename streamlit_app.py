...
df_filtered = df_filtered.round({'01.12.2023': 1, '01.11.2024': 1, '01.12.2024': 1})
...
st.write('The following report was generated by Cohere large language model "command-r-plus-08-2024": https://docs.cohere.com/v2/docs/command-r-plus')
st.write(report)
